...
export function Dashboard(){
  ...
  async function loadTransactions(){
    ...
    const totalInterval = lastTransactionExpesives === 0 ? 'Não há transações' :`01 a ${lastTransactionExpesives}`;
    ...
    setHighlightData({
      ...
      lastTransaction: lastTransactionExpesives === 0 ? 'Não há transações' :`Última saída dia ${lastTransactionExpesives}`
      },
      total: {
